...
<SectionFrame id="contact" eyebrow="contact" title="Let's Connect !" class="text-center">
    ...
    <div class="flex flex-wrap gap-4 justify-center items-center">
        ...
        <!-- Tombol Email (Ukuran Large) -->
        <Button
            variant="outline"
            size="lg"
            href="mailto:imaldini328@gmail.com"
            class="flex items-center gap-2.5 px-5 py-6 text-base"
        >
            <Mail class="h-5 w-5" />
            Email Saya
        </Button>

        <!-- Tombol GitHub (Ukuran Large) -->
        <Button
            variant="outline"
            size="lg"
